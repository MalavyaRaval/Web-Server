...
public class NotModifiedResponseWriter extends ResponseWriter {
    ...
    public NotModifiedResponseWriter(OutputStream out, IResource testResource, HttpRequest httpRequest) {
    ...
    public void write() {
        ...
        try {
            HttpResponse httpResponse = new HttpResponse(HttpResponseCode.NOT_MODIFIED, "HTTP/1.1");
