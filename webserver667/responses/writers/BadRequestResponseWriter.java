...
public class BadRequestResponseWriter extends ResponseWriter {
    ...
    public BadRequestResponseWriter(OutputStream out, IResource testResource, HttpRequest httpRequest) {
    ...
    public void write() {
         ...
         try {
                        HttpResponse httpResponse = new HttpResponse(HttpResponseCode.BAD_REQUEST, "HTTP/1.1");
