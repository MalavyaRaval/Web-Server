...
public class NotFoundResponseWriter extends ResponseWriter {
    ...
    public NotFoundResponseWriter(OutputStream out, IResource testResource, HttpRequest httpRequest) {
    ...
    public void write() {
        ...
        try {
            HttpResponse httpResponse = new HttpResponse(HttpResponseCode.NOT_FOUND, "HTTP/1.1");
